...
const ASPECT_RATIOS = ['4/3', '3/4', '6/4', '4/6', '16/9', '9/16', '21/9', '9/21', '1/1'];
      ...
      <Box sx={boxStyles}>
        ...
        <Image
          ...
          slotProps={{
            overlay: {
              sx: (theme) => ({
                backgroundImage: `linear-gradient(to bottom, transparent, ${varAlpha(
        ...
        <Image
          ...
          slotProps={{
            overlay: {
              sx: (theme) => ({
                backgroundImage: `linear-gradient(to top, ${varAlpha(
                  theme.vars.palette.secondary.mainChannel,
                  0.24
                )}, ${varAlpha(theme.vars.palette.info.mainChannel, 0.8)})`,
              }),
            },
          }}
        />
            ...
            overlay: {
              sx: (theme) => ({
                backgroundImage: `linear-gradient(to top, ${varAlpha(
                  ...
                  0.24
                )}, ${varAlpha(theme.vars.palette.success.mainChannel, 0.8)})`,
              }),
            },
          }}
        />

import { pxToRem, remToPx, varAlpha } from 'minimal-shared/utils';
...
export function ElearningLandingHero({ sx, ...other }) {
  ...
  const renderTexts = () => (
    <>
      <Typography variant="h1" typography={"h2"}   >
        อย่าหยุด
        ...
        <Box component="span" sx={{ color: 'primary.dark', textDecoration: 'underline' }}>
          {` พัฒนา`}
        </Box>
      ...
      >
      ทุกบทเรียนคือก้าวใหม่ เราพร้อมอยู่เคียงข้างคุณในทุกเส้นทาง
      </Typography>
    </>
  );

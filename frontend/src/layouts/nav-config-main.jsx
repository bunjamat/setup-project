...
export const navData = [
  { title: 'หน้าแรก', path: '/' },
  { title: 'หลักสูตร', path: paths.components, children: pageLinks  },
  { title: 'บุคลากร', path: paths.pages,},
  // { title: 'ระบบคลังหน่วยกิต', path: paths.docs }, 
  { title: 'ติดต่อเรา', path: paths.docs },
];
